...
//        joystickPOVdown.whenPressed(new Descendre1etage());
        ...
        SmartDashboard.putData("Etage 0", new EtageGoto(0));
        SmartDashboard.putData("Etage 1", new EtageGoto(1));
        SmartDashboard.putData("Etage 2", new EtageGoto(2));
        SmartDashboard.putData("Etage 3", new EtageGoto(3));
        SmartDashboard.putData("Etage 4", new EtageGoto(4));
        SmartDashboard.putData("Etage 5", new EtageGoto(5));
        SmartDashboard.putData("Etage 6", new EtageGoto(6));
        SmartDashboard.putData("Etage 7", new EtageGoto(7));
